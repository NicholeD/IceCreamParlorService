...
public class PriceManager {
    ...
    public List<BigDecimal> calculateStateTotalPrices(List<BigDecimal> prices, BigDecimal salesTax) {
        Function<BigDecimal, BigDecimal> calculate = price -> price.multiply(salesTax);

        return priceCalculator.calculateTotalPrices(prices, calculate);
    }
    ...
    public List<BigDecimal> calculateStateTotalPrices(List<BigDecimal> prices, BigDecimal setupFee, BigDecimal
            salesTax) {
        Function<BigDecimal, BigDecimal> calculate = price -> price.add(setupFee).multiply(salesTax);
    ...
    public List<BigDecimal> calculateStateTotalPrices(List<BigDecimal> prices, BigDecimal setupFee, BigDecimal salesFee,
        ...
        Function<BigDecimal, BigDecimal> calculate = price -> price.add(setupFee).add(salesFee).add(countyFee);
